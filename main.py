...
mutation_frequency = 4 # Mutation frequency. Means how many genes will change its places.
...
beehive.initialize_population(method='random', randomness_ratio=0.99, swap_count=1, swap_method='neighbour_swap') # METHOD: 'random' or 'nearest_flower' or 'hybrid'. SWAP method: 'neighbour_swap' or 'random_swap'.
